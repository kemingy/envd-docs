...
这一切都要归功于我们的社区，我们非常感谢他们的支持与帮助。我们在持续更新 `envd` 的 [roadmap](/zh/community/roadmap.html) 和[贡献者指南](/zh/community/contributing.html)，以便社区可以更好地了解我们的计划。
...
如果你想了解更多关于 envd 的信息，可以查看我们的[官方文档](/zh/)。也欢迎加入我们的 [discord 频道](https://discord.gg/KqswhpVgdU)，与我们一起讨论。
